		...
		<div className="">
			...
			<div className='bg-pink-300/20 p-2'>
				...
				>
					...
					<span className="mx-2 absolute inset-x-0 bottom-2 h-1 bg-fuchsia-800 transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span>
					<span className="mx-2 absolute inset-x-0 top-2 h-1 bg-fuchsia-800 transform origin-right scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></span>
					<span className="my-2 absolute inset-y-0 left-2 w-1 bg-fuchsia-800 transform origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-500"></span>
					<span className="my-2 absolute inset-y-0 right-2 w-1 bg-fuchsia-800 transform origin-top scale-y-0 group-hover:scale-y-100 transition-transform duration-500"></span>
