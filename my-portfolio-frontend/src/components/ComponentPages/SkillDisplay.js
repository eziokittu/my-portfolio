		...
		>
			...
			<Fade>
				<button 
					...
					bg-pink-300/100 w-fit mx-auto rounded-lg p-4 mb-2
					'
				>
					...
					>
						<svg 
							...
							viewBox="0 0 32 32" 
							className='group-hover/g1:animate-[pulse_.7s_ease-in-out_infinite] stroke-violet-950 fill-pink-200  w-[40px] xsm:w-[60px] md:w-[100px] mr-4'>
					...
					{/* The title */}
					<span className='flex flex-wrap items-center justify-center font-Kolnia text-lg 2xsm:text-xl xsm:text-2xl sm:text-4xl xl:text-6xl'>
