...
const Project = (props) => {
  ...
  return (
    <div className="relative z-0">
      <div className=" bg-slate-200/80 p-4 sm:container sm:mx-auto mt-0">
        ...
        <div className="sm:container w-full mx-auto h-40 bg-gradient-to-b from-slate-200/80 to-transparent"></div>
    </div>
  );

  return (
    <div className='bg-black w-full p-4 mx-auto text-white'>loading projects...</div>
  )
}
